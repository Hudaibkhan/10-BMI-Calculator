...
export default function BmiCalculator() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-blue-400 dark:bg-gray-900">
      {/* Center the BMI calculator card within the screen */}
      <Card className="w-full max-w-md mx-auto bg-blue-200 shadow-2xl">
        <CardHeader>
        ...
        <CardContent className="space-y-4">
          ...
          <Button onClick={calculateBmi} variant={"default"}>Calculate</Button>
